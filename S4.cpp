        ...
        if(i5 == 1){
            ...
            if (pclist.find(c) == pclist.end()){        //if pc is not in the list
                ...
                if (i7==1){
                    ...
                    //Writing the received public on a file
                    std::ofstream oo1;
                    oo1.open(+"S4 Time per beacon V" + nn, std::ios_base::app);        
                    //write on the file
            ...
            {   
                ...
                if(count_for_check % (5+adder) == 0){
                    ...
                    if (i2==1){
                        ...
                        //      //Writing the received public on a file
                        //     std::ofstream oo;
                        //     oo.open(+"S4 times V" + nn, std::ios_base::app);        //appends to the file and not overwrite
                        //     //write on the file
                        //     oo<<i4<<": "<<duration.count()<<std::endl;                      
                        //     //close the file
                        //     oo.close();
                        //     i4++;
                        // }
                ...
                if(keylist.find(sha256(get_key(rbuf))) != keylist.end() || keylist.find(sha256(sha256(get_key(rbuf)))) != keylist.end())
                {
                    ...
                    if (i9==1)
                    {
                        ...
                        cbh = get_coophash(rbuf);
                        if(storedhashlist.find(cbh) != storedhashlist.end()){       //if hash is found in the list
                            std::cout<<"Beacon "<<it2->second<<" also validated through cooperative beacon verification";
                            storedhashlist.erase(cbh);
                            adder = count_for_check;

                            auto stop1111 = high_resolution_clock::now();
                            auto duration1111 = duration_cast<microseconds>(stop1111 - start1); 

                            //Writing the received public on a file
                            std::ofstream oo1;
                            oo1.open(+"S4 Time per beacon V" + nn, std::ios_base::app);        
                            //write on the file
                            oo1<<duration1111.count()<<std::endl;                      
                            //close the file
                            oo1.close();

                            // if (i6 == 50){
                            //     auto stop5 = high_resolution_clock::now();
                            //     auto duration5 = duration_cast<microseconds>(stop5 - start); 
                            ...
                            //     oo.open(+"S4 times V" + nn, std::ios_base::app);        //appends to the file and not overwrite
                            //     //write on the file
                            //     oo<<i4<<": "<<duration5.count()<<std::endl;                      
                            //     //close the file
                            //     oo.close();
                            //     i4++;
                            // }
                        ...
                        oo1.open(+"S4 Time per beacon V" + nn, std::ios_base::app);        
                        //write on the file
                        oo1<<duration111.count()<<std::endl;                      
                        //close the file
                        oo1.close();
                    
                        // if (i6 == 50){
                        //     auto stop9 = high_resolution_clock::now();
                        //     auto duration9 = duration_cast<microseconds>(stop9 - start); 
                        ...
                        //     oo.open(+"S4 times V" + nn, std::ios_base::app);        //appends to the file and not overwrite
                        //     //write on the file
                        //     oo<<i4<<": "<<duration9.count()<<std::endl;                      
                        //     //close the file
                        //     oo.close();
                        //     i4++;
                        // }
